  ...
  render() {
    ...
    return (
      <div className="video__section">
        <h2 className="video__section--title">
          {this.props.currentVideo.title}
        </h2>
        <table className="video__section--table">
          <tr>
            <td className="video__section--user__name">
              By {this.props.currentVideo.channel}
            </td>
            <td className="video__section--date">
              {new Date(this.props.currentVideo.timestamp).toLocaleDateString(
                "en-US"
              )}
            </td>
          </tr>
          <tr>
            <td className="video__section--views__container">
              ...
              <div className="video__section--views">
            ...
            <td className="video__section--likes__container">
              ...
              <div className="video__section--likes">
                {this.props.currentVideo.likes}
              </div>
            </td>
          </tr>
        </table>
        <div className="video__section--description">
          {this.props.currentVideo.description}
        </div>
        <div className="video__section--comment__count">
